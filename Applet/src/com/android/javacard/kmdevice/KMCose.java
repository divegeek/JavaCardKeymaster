...
public class KMCose {
  ...
  public static byte[] COSE_TEST_KEY; // -70000
  ...
  public static byte[] CODE_HASH;
  public static byte[] CODE_DESCRIPTOR;
  public static byte[] CONFIG_HASH;
  public static byte[] CONFIG_DESCRIPTOR;
  public static byte[] AUTHORITY_HASH;
  public static byte[] AUTHORITY_DESCRIPTOR;
  public static byte[] MODE;
  public static byte[] SUBJECT_PUBLIC_KEY;
  public static byte[] KEY_USAGE;
  // text strings
  public static byte[] TEST_ISSUER_NAME; // "Issuer"
  public static byte[] TEST_SUBJECT_NAME; // "Subject"
  public static byte[] KEY_USAGE_SIGN; // Key usage sign
