 ...
 * short length;} followed by sequence of short pointers to KMType instances. The subType can be
 * 0 if this is an array or subType is short KMType value e.g. KMType.BYTE_BLOB_TYPE if this is a
