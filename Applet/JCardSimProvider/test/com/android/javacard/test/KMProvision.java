...
public class KMProvision {
  ...
  public static ResponseAPDU provisionDeviceUniqueKeyPair(CardSimulator simulator,
    ...
    Util.arrayFillNonAtomic(RKP_DK_PUB, (short) 0, (short) 65, (byte) 0);
    Util.arrayCopyNonAtomic(privKey, (short) 0, RKP_DK_PRIV, (short) (32 - lengths[0]), (short) lengths[0]);
    Util.arrayCopyNonAtomic(pubKey, (short) 0, RKP_DK_PUB, (short) 0, (short) lengths[1]);
