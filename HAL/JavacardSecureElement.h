...
enum class Instruction {
    // Keymaster commands
    // Aligned INS_INIT_STRONGBOX_CMD value with Keymaster instruction set
    INS_INIT_STRONGBOX_CMD = 0x08,
    ...
    // RKP Commands
    INS_GET_RKP_HARDWARE_INFO = KEYMINT_CMD_APDU_START + 26,
    INS_GENERATE_RKP_KEY_CMD = KEYMINT_CMD_APDU_START + 27,
    INS_BEGIN_SEND_DATA_CMD = KEYMINT_CMD_APDU_START + 28,
    INS_UPDATE_KEY_CMD = KEYMINT_CMD_APDU_START + 29,
    INS_UPDATE_EEK_CHAIN_CMD = KEYMINT_CMD_APDU_START + 30,
    INS_UPDATE_CHALLENGE_CMD = KEYMINT_CMD_APDU_START + 31,
    INS_FINISH_SEND_DATA_CMD = KEYMINT_CMD_APDU_START + 32,
    INS_GET_RESPONSE_CMD = KEYMINT_CMD_APDU_START + 33,
};
