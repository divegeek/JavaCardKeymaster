...
constexpr int kBootParamsCmd = INS_BEGIN_KM_CMD + 3;
constexpr int kLockProvisionCmd = INS_BEGIN_KM_CMD + 4;
constexpr int kGetProvisionStatusCmd = INS_BEGIN_KM_CMD + 5;
